            ...
            <div className='mx-auto md:m-24'>
                ...
                <div className="mb-12 text-center">
                    ...
                    <div className="text-left mx-6 flex flex-col space-y-6">
                        ...
                        <p>
                            - I am really passionate about this to the point of getting lost in my ideas frequently.
                        </p>
                    </div>
                </div>
                <div className="mb-12 text-center">
                    <h3 className="text-[3rem] font-bold mb-10 underline leading-[2rem]">Technical skills and experience</h3>
                    <div className="text-left mx-6 flex flex-col space-y-6">

                        <p>
                            - I have experience in handling libraries and frameworks such as: python | JavaScript | html | CSS | SASS | Django | Django Rest Framework | Rest | JWT | Postman | React | Redux | Next.js | node.js | Postgresql | SQLite | Mongodb | firebase | Heroku | Git | GitHub | GitHub Actions | Docker | TailwinCSS | Bootstrap | Bootstrap | Bootstrap | Bootstrap | Bootstrap
                        </p>
                        <p>
                        ...
                        <p>
                            - I also know other sectors such as; civil construction, agriculture, ecology, agroecology, education, health, healthy lifestyle, physiotherapy, philosophy, history, martial arts, digital marketing, SEO, copywriting and design.
                        </p>
                    </div>
                </div>
            </div>
