...
const Me = () => {
    ...
    return (
        <div className='mb-24 mt-24'>
            ...
            <p className='text-center font-bold text-xl md:text-4xl mx-[10%] md:mx-[25%]' >
                I am <span className='underline'>Angel Riera</span> a FullStack web developer specialized in Django and React
            </p>

            <div className='w-full mx-auto px-3 sm:px-24 mt-8 '>
                <div className="w-full flex justify-around space-x-2 md:space-x-12 ">
                    {feat.map((e, i) => (
                        <a key={i} href="https://github.com/Angel7dv" target="__blank">
                            <div className='px-2 py-10 rounded-3xl flex flex-col items-center border bg-indigo-800 w-full' >
                                <div className='h-12 w-12 bg-slate-400 flex justify-center items-center rounded-full'>
                                    {e.icon}
                                </div>
                                <span className='my-4 text-center font-bold text-slate-300 underline underline-offset-1'>
                                    {e.title}
                                </span>
                                <span className='text-center text-sm ext-slate-400 '>
                                    {e.sub_title}
                                </span>
                            </div>
                        </a>
